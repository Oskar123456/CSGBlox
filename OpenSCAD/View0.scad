difference()
{
        ...
        union()
        {
            union()
            {
                ...
                rotate([90.0, 0.0, 0.0])
                {
                    ...
                    {
                        linear_extrude(height = 11.2, twist = 0.0, scale = 1.0, slices = 1, center = false)
                        {
                            M212();
                        }
                    }
            ...
            translate([0.0, 0.0, 4.3999999999999995])
            {
    ...
    {
        translate([0.0, 0.5999999999999996, 0.0])
        {
            translate([0.0, 3.2, 0.0])
            {
                translate([0.0, 0.5999999999999996, 0.0])
                {
                    mirror([0.0, 1.0, 0.0])
                    {
                        translate([0.0, -3.8000000000000007, 0.0])
                        {
                            rotate([-90.0, 0.0, 0.0])
                            {
                                union()
...
module M246()
{
    linear_extrude(height = 18.0, twist = 0.0, scale = 1.0, slices = 1, center = false)
    {
        M243();
    }
}
...
module M231()
{
    ...
    (
        ...
        [
            [0.0, 0.2], 
            [3.6, 0.2], 
            [4.3999999999999995, 1.4000000000000001], 
            [4.3999999999999995, 1.6], 
            [4.0, 2.2], 
            [4.0, 9.8], 
            [0.0, 9.8]
        ],
...
module M238()
{
    ...
    (
        ...
        [
            ...
            [3.6, 3.6000000000000005], 
            [4.3999999999999995, 2.4000000000000004], 
            [4.3999999999999995, 2.2000000000000006], 
            [4.0, 1.6000000000000005], 
            [4.0, 0.0], 
            [0.0, 0.0]
        ],
        paths =
...
module M207()
{
    ...
    {
        linear_extrude(height = 4.8, twist = 0.0, scale = 0.8214285714285714, slices = 1, center = true)
        {
            M200();
        }
    }
...
module M223()
{
    translate([0.0, 0.0, 1.6999999999999997])
    {
        mirror([0.0, 0.0, 1.0])
        {
            linear_extrude(height = 3.3999999999999995, twist = 0.0, scale = 0.575, slices = 1, center = true)
            {
                M216();
            }
        }
...
module M216()
{
    scale([6.3999999999999995, 6.3999999999999995])
    {
        M213();
    }
}
